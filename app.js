...
headDropdown.addEventListener('change', () => {
    ...
    const head = headDropdown.options[headDropdown.selectedIndex].value;
...
middleDropdown.addEventListener('change', () => {
    ...
    const middle = middleDropdown.options[middleDropdown.selectedIndex].value;
...
bottomDropdown.addEventListener('change', () => {
    ...
    const bottom = bottomDropdown.options[bottomDropdown.selectedIndex].value;
